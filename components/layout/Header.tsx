...
export function Header() {
  return (
    <header className="sticky top-0 z-20 hidden border-b border-astro-border bg-astro-bg/88 shadow-[0_10px_45px_rgba(0,0,0,0.18)] backdrop-blur lg:block">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
        <div>
          ...
          <p className="mt-1 text-sm text-astro-text">Astronomy briefs, sky events, and calm space awareness.</p>
        </div>
