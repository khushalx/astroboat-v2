  ...
  return (
    <PageShell className="max-w-3xl">
      ...
      <AstroCard as="article" className="divide-y divide-astro-border/70 p-0 text-sm leading-7 text-astro-muted">
        ...
        <section className="p-5 sm:p-6">
          <h2 className="font-display text-xl font-normal text-astro-text">Assistant Messages</h2>
          <p className="mt-2">
        ...
        <section className="p-5 sm:p-6">
          <h2 className="font-display text-xl font-normal text-astro-text">Third-Party Services</h2>
          <p className="mt-2">
        ...
        <section className="p-5 sm:p-6">
          <h2 className="font-display text-xl font-normal text-astro-text">Personal Data</h2>
          <p className="mt-2">
        ...
        <section className="p-5 sm:p-6">
          <h2 className="font-display text-xl font-normal text-astro-text">Privacy Questions</h2>
          <p className="mt-2">
